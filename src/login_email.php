...
<div class="form-container">
    ...
    <form class="form1" action="client_logon.php" method="POST">
        <h2>Login to Hamba Kahle (For Rider)</h2>
        <input type="text" placeholder="Please enter Email" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="username/email required" required><br>
        <input type="password" placeholder="Please enter Password" id="password" name="password" pattern=".{5,}" title="five or more letters/numbers" required><br>
        ...
        <a href="forgot_password.php" class ="b">Forgot password?</a><br><br>
        <input type="submit" name="submit" value="Login"><br><br>
        Not registered? <a href="sign_up.php" class ="b">Create an account</a><br>
