...
<div class="form-container">
    <nav>
    <form class="form1" action="driver_logon.php" method="POST">
        <h2>Login to Hamba Kahle (For driver)</h2>
        <input type="text" name="email" placeholder="Please enter Email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="username/email required" required><br>
        <input type="password" name="password" placeholder="Please enter Password" id="password" pattern=".{5,}" title="five or more letters/numbers" required><br>
        ...
        <! ––<input type="submit" name="submit" value="Back"><br></form>
        Not registered? <a href="sign_up(driver).php">Create an account</a><br>
