...
<ul class = "OrderForList">
  ...
  <li class = "List"><a href="login_email.php"><i class="fas fa-users"></i> Login</a></li>
    ...
    <button onclick="location.href='login_email.php'" type="button" class ="button" >Rider</button>
    <button onclick="location.href='login_driver.php'" type="button" class ="button" >Driver</button>
    <button onclick="location.href='login_admin.php'" type="button" class ="button" >Admin</button>
